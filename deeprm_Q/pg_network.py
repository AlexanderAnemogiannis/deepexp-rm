...
### policy gradient learner, represented by neural netwwork
class PGLearner:
    def __init__(self, pa):
        ...
        # ===================================
        ### output of NN - probability distribution over actions
    ...
    ### return prob. dist over actions for a given state, agent
